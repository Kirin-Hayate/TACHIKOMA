"""
==============================================================================
作業領域広角グリッドスイープ (-110°〜+110° ➔ 正面30cm Place) 検証テスト
(tests/test_grid_sweep_to_center.py)
==============================================================================
【動作仕様】
  1. 角度: -110° 〜 +110° (10°刻み, 23分割)
     距離: 0cm 〜 65cm (5cm刻み, 14分割)
     の計 322通りについて、Place 地点「正面 (0°), 30cm, z=15mm」への
     Pick & Place 軌道成立を判定。
...
def main():
    # 角度: -110° 〜 +110° (10°刻み, 23点)
    angles = list(range(-110, 111, 10))
    # 距離: 0cm 〜 65cm (5cm刻み, 14点)
    distances_cm = list(range(0, 66, 5))
    ...
    print("=======================================================================")
    print(" 🔍 作業領域広角グリッドスイープ (Pick ➔ 正面30cm Place) を事前計算中...")
